...
class Num2WordsPLTest(TestCase):
    def test_cardinal(self):
        ...
        self.assertEqual(
            num2words(123.50, lang="pl"), "sto dwadzieścia trzy przecinek pięć"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            num2words(
                963301000001918264129471001047146102 * 10 ** 30 + 1007, lang="pl"
            ),
    ...
    def test_currency(self):
        ...
        self.assertEqual(
            num2words(10111, lang="pl", to="currency", currency="EUR", separator=" i"),
            "sto jeden euro i jedenaście centów",
        )
        self.assertEqual(
            num2words(10121, lang="pl", to="currency", currency="PLN", separator=" i"),
        ...
        self.assertEqual(
            num2words(123.50, lang="pl", to="currency", currency="PLN", separator=" i"),
